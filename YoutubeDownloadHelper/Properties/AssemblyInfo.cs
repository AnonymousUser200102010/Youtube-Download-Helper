...
//The assembly version's main and secondary values "x.x" are set to be one less than the next update.
//for instance, if the next update to be released is 2, the version here should be 1.